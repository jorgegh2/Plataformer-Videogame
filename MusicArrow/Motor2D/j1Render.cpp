...
{
	BROFILER_CATEGORY("RenderUpdate", Profiler::Color::Green);
	return true;
}

bool j1Render::PostUpdate()
{
	BROFILER_CATEGORY("RenderPresent", Profiler::Color::GreenYellow);
...
// Blit to screen
bool j1Render::Blit(SDL_Texture* texture, int x, int y, const SDL_Rect* section, bool inCamera, SDL_RendererFlip flip, float speed, double angle, int pivot_x, int pivot_y) const
{
	bool ret = true;
